...
public class WifiUtils {
  ...
  public static boolean isWifiConnect() {
    NetworkInfo mNetworkInfo =
      ((ConnectivityManager) mContext.getSystemService(Context.CONNECTIVITY_SERVICE)).getNetworkInfo(ConnectivityManager.TYPE_WIFI);
    ...
    try {
      ...
      while (en.hasMoreElements()) {
        ...
        while (enumIpAddr.hasMoreElements()) {
          ...
          if (!mInetAddress.isLoopbackAddress() && isIP(mInetAddress.getHostAddress())) {
